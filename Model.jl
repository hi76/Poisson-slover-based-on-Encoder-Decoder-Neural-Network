...
Conv(kernel_size::Int,in_channel::Int,out_channel::Int) = Conv(param(kernel_size,kernel_size,kernel_size,in_channel,out_channel;atype=Atype), param0(1,1,1,out_channel,1;atype=Atype), param(1,1,1,out_channel,1;atype=Atype))
...
deConv(kernel_size::Int,in_channel::Int,out_channel::Int) = deConv(param(kernel_size,kernel_size,kernel_size,out_channel,in_channel;atype=Atype), param0(1,1,1,out_channel,1;atype=Atype), param(1,1,1,out_channel,1;atype=Atype))
